...
public class ServerBuilding : MonoBehaviour
{
	...
	public virtual void Init(LidServer a_server, int a_type, int a_ownerPid = 0, int a_health = 100, bool a_isNew = true)
	{
		...
		m_dbBuilding = new DatabaseBuilding(a_type, base.transform.position.x * 1.00001f, base.transform.position.z * 1.00001f, base.transform.rotation.eulerAngles.y * 1.00001f, a_ownerPid, a_health);
