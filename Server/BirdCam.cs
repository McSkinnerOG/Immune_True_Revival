...
public class BirdCam : MonoBehaviour
{
	...
	private void LateUpdate()
	{
		if (!(null == m_target))
		{
			...
			Vector3 vector = m_startOffset * (m_zoom + m_zoomAdd);
			Vector3 vector2 = m_target.forward * m_lookDirInfluence;
			m_targetOffset += (vector2 - m_targetOffset) * deltaTime;
			base.transform.position = m_target.position + m_targetOffset + vector;
		}
	}
}
