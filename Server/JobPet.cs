...
public class JobPet : JobBase
{
	...
	public void SetAggressor(Transform a_aggressor)
	{
		...
		{
			m_body.Attack(a_aggressor, a_approach: true);
	...
	private void ResetAttack()
	{
		...
		m_body.Attack(null, a_approach: false);
	}
	...
	private void PickupNearestFood()
	{
		...
		{
			DatabaseItem nearestItem = m_server.GetNearestItem(base.transform.position, a_petFoodOnly: true);
